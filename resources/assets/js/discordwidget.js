        ...
        render : function() {
          ...
          function renderAll() {
            ...
            function renderWidget(d, p) {
              ...
              var defaultInnerHtml = '<ul class="discord-tree"></ul><p class="discord-users-online"></p><div class="discord-join"></div><div class="discord-fade"></div>';
              var formatted = '';
              var gameName = '';
              ...
              if (d.instant_invite != 'null') {
                ...
                discordJoin='<a class="btn button sk-btn" href="'+d.instant_invite+'">Join Discord</a>'
              }
